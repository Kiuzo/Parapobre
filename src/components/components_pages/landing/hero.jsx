export default function HeroComponent() {
    return (
        <header>
            <div className="hero flex flex-col min-h-screen text-white justify-center items-center gap-8 px-4 text-center">
                <h1 className="text-4xl md:text-6xl sm:text-2xl font-bold">
